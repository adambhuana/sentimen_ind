...
#with open('/content/tweets-data/covid.csv') as csv_file:
#    with open('komen.txt', 'w') as f:
...
with open('kesan_negatif.txt', encoding ='ISO-8859-2') as f:
    with open('nilai_negatif.txt', 'w') as f1:
        for text in f.read().split('\n'):
            print(text)
            hasil=senti.main(text)
            f1.write(hasil)
            f1.write("\n")
        print()
        
with open('kesan_positif.txt', encoding ='ISO-8859-2') as f:
    with open('nilai_positif.txt', 'w') as f1:
        for text in f.read().split('\n'):
            print(text)
            hasil=senti.main(text)
            f1.write(hasil)
            f1.write("\n")
        print()
#with open('kepercayaan.txt', encoding ='ISO-8859-2') as f:
#    with open('nilai_percaya.txt', 'w') as f1:
#        for text in f.read().split('\n'):
#            print(text)
#            hasil=senti.main(text)
#            f1.write(hasil)
...
#with open('kritik.txt', encoding ='ISO-8859-2') as f:
#    with open('nilai_kritik.txt', 'w') as f1:
#        for text in f.read().split('\n'):
#            print(text)
#            hasil=senti.main(text)
#            f1.write(hasil)
#            f1.write("\n")
#        print()
#with open('percayataman.txt', encoding ='ISO-8859-2') as f:
#    with open('nilai_taman.txt', 'w') as f1:
#        for text in f.read().split('\n'):
#            print(text)
#            hasil=senti.main(text)
#            f1.write(hasil)
#            f1.write("\n")
#        print()
#with open('percayadesign.txt', encoding ='ISO-8859-2') as f:
#    with open('nilai_design.txt', 'w') as f1:
#        for text in f.read().split('\n'):
#            print(text)
#            hasil=senti.main(text)
#            f1.write(hasil)
#            f1.write("\n")
#        print()
#path='E:\\project_kritik_saran\\sentistrength_id-master'
#tweets = open(os.path.join(path, 'tweet_only.txt'),'r').read()
#tweets_list = tweets.split('\n')
#mycursor = mydb.cursor()
#mycursor.execute("SELECT idkomen,komen from tblkomen")
#myresult = mycursor.fetchall()
#for x in myresult:
#        tnp=x[1]
#        tnp1=x[0]
#        hasil=senti.main(tnp)
#        sql = "UPDATE tblkomen SET kelas= %s WHERE idkomen = %s"
#        val = (hasil,tnp1)
#        mycursor.execute(sql, val)
#mydb.commit()
#print("Proses Pengolahan Data Kritik/Saran Telah Selesai.")