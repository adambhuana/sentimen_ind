...
class sentistrength:
    def __init__(self, config=dict()):
        self.negasi = [line.replace('\n','') for line in open("negativeword.txt").read().splitlines()]
...
with open('komentar_dbs_reguler.csv') as csv_file:
    with open('komen_dbs_reguler_1.txt', 'w') as f:
...
with open('komen_dbs_reguler_1.txt', encoding ='ISO-8859-2') as f:
    with open('nilai_dbs_reguler_1.txt', 'w') as f1:
